...
分支 windows-deploy-2026-09-10，**当前 HEAD `3c7588e`（已推送 GitHub，工作区干净）**。原件在本机受控路径，摘要已脱敏。
...
| 动作 | ACTION_MODE=OFFICIAL，ONEBOT_ACTION_STAGE=recall_only，D-025 授权 5 群 |
| 急停 | EMERGENCY_STOP=false（可用后台按钮/.env/动作开关三层触发） |
| 保留期 | 15/15 天 + 每日 04:00 自动清理 |
...
> **主审提示**：v10/v11 显著放宽自动拦截（负责人明确授权并知晓洗白风险，见提交 8154b65/3c7588e）。审核时请评估该口径下的残余风险与人工兜底是否充分（后台案件清理/群管理/急停均在）。

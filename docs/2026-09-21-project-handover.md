...
| 当前卡点 | A2 已由负责人授权本任务裁定、隔离实现；生产上线需维护窗口，N03 处置与整机恢复仍未验收 |
...
负责人已授权我方主审/实施；候选位于 `codex/r132-authority-20260922`，按该分支验收记录核对全量、适配、CI 和合成恢复。不要在生产 checkout 提前引入新 migration。线上旧写工具与 A2 写工具不得混用；实际迁移/回填/同窗上线需负责人另行确认维护窗口。
...
外部输入仍包括：**A2 生产上线及回滚演练窗口**、**历史缺失证据与 N03 处置清单审核**；分页与稳定性修复已随 MEDIA-QUOTA 授权恢复加载，证据见恢复记录。当前新增的电脑空间限制巡检及其未验证边界见 [本轮记录](2026-09-21-space-inspector.md)，不以旧手机路线作为前提。

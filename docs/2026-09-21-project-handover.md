...
| CI | 备份源码 `7b040b8` 的 run `35736054871`、文档 `4182767` 的 run `35738746024` 三 job 成功，实际 checkout/命令见每日备份记录；后续文档 HEAD 仍须独立核验 |
...
| 生产快照 | 审核源码 `1c17ba0` / `t204-v18`，最新只读急停 false；原进程和群授权/动作未变，备份任务已启用且首跑/隔离恢复通过 |

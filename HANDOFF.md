...
**T-306 NapCat/OneBot入站Adapter与影子运行器：已在分支 `feature/t306-onebot-shadow` 完成实现与本地全量门禁，待主审独立审核（未验收）。** 设计决策记录为 D-021。审核通过后进入 T-303（Windows隔离群W1影子验证），随后 `T-307 → T-404 → T-403`；T-304人工批准踢人为T-307之后的可选增强。

## 已完成内容

### T-306 实现（2026-09-08，实现Agent）

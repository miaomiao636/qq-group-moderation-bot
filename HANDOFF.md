...
**CAMPUS-SCOPE-20260922 最新交接：源码 `212488f` 已推送，冻结全量、主审探针、门禁与源码 CI 均通过；Windows 提权启动返回取消，生产未更新。** 原服务继续运行。精确 SHA、命令、CI 与后续权限步骤见 [本轮记录](docs/2026-09-22-campus-source-scope.md)。不得擅自绕过系统权限或把待部署写成已生效。

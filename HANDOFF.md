...
- **百群负载与延迟**：**基线已完成**（13 群/日均 ~800 条/峰值 313 条·小时/积压 0；AI 24h p50 1.6s、p95 5.3s；历史 17.4s 根因≈mimo-v2.5 已停用）——详见 `docs/evidence/2026-09-15-capacity-baseline.md`；第②③步（优化建议 + 隔离实例合成压测）待执行。

...
R-101/W0/T-001/T-002核心均已通过。**P1 最小可运行审核链路（T-102/T-103/T-104）已全部交付（2026-09-05）**：统一消息契约与官方适配器、文字规则引擎（黑名单/变体/联系方式/刷屏/保护角色）、两次违规阶梯与案件状态机（双出口互斥、误判撤销）。91项测试全绿、mypy/ruff全过。负责人已授权连续推进至验收前。**当前推进：T-201 图片/GIF审核**；后续队列：T-202、T-203、T-301、T-302、T-401、T-402。

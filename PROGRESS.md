...
本地全量 **1099 passed / 13 条件跳过 / 0 失败**；ruff/format/mypy 85 文件通过。上一受审 SHA `4e26252` 的远程 CI 三 job 全绿；新 SHA CI 以 PR #7 检查页为准。Windows 服务已重启加载，真实动作保持关闭；恢复动作/生产删除/历史重写未授权。现场待办：真实 TUN 下载实测、隔离副本清理/恢复验收、独立新 W2、百群负载与延迟、通知接管/故障演练、W3–W5。

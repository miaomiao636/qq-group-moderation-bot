...
负责人已选择 A：只对明确确认的万能校园墙来源保留原有豁免，其他小程序恢复正常审核。新契约、原始探针封存与逐处适配见 [本轮记录](docs/2026-09-22-campus-source-scope.md)。当前为隔离候选，生产加载状态以该记录为准；不得把本次范围变更解释为启用 image_hash enforce 或修改群授权、阈值。


**A2-DEPLOY-20260922 已上线**：负责人明确授权“方案 A 上线”；真实备份副本验证后，已正常停服、迁移/回填、身份对账并恢复服务。当前加载源码 `53683d5998588f3b7490f4e73774df313b17b51d`，新 revision `e1c7d4b8a902`。命令、证据和未完成边界见 [上线记录](docs/2026-09-22-authority-a2-deployment.md)。此前“生产未部署/待窗口”为历史状态；整机恢复与 N03 仍待办。

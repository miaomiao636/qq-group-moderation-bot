...
**CASE-BATCH-5000-20260926（已上线）**：源码 `4e2a578` 已加载，每次最多 5000 案，预览明确列出并跳过已关闭及证据身份错连案件。82 项批量回归、本机 2806 passed / 19 skipped、Ruff/格式/mypy 和源码三项 CI 通过。新 D 盘备份完整性、外键及哈希校验后，仅重启 Web；OneBot 已恢复 ready/online 并处理自然消息，Runtime、急停与群配置不变。未代用户结案或改写历史证据。命令、时间及收据见 [上线记录](docs/2026-09-23-case-batch.md#批量-5000-授权部署2026-09-26)。负责人此前反馈全页 CSV 导出与客户端实际撤回成功，不据此回填自动通知计数。
